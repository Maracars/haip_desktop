...
public final class ActionMessages {
	public static final String CONNECTION_ESTABLISHED = "Serial connection has been established\n";
	public static final String CONNECTION_CLOSED = "Serial connection has been closed\n";

	public static final String SYSTEM_INITIALIZED = "Port system has been initialized\n";
