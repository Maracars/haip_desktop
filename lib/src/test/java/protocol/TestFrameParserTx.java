...
public class TestFrameParserTx {
	...
	private static final String PACKET_OK_NO_CHECK_NO_DATA = "000000000000000011111111";
	private static final String PACKET_OK_NO_CHECK_1_BYTE_DATA = "00110000000000001111111110000111";
	private static final String PACKET_OK_NO_CHECK_2_BYTE_DATA = "0101000000000000111111111010001110101010";
	...
	private List<String> createMyByteList(Frame frame) {
		List<String> myByteList = new ArrayList<>();
